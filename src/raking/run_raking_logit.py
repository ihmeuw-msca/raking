...
# Raking with inequality constraints with weights (logit distance)
males_raked_inequality_logit = []
for year in years:
    ...
    res = raking_logit_inequality(y, A, s, C, c, q, l, h)
    ...
    males_raked_inequality_logit.append(df_raked)
males_raked_inequality_logit = pd.concat(males_raked_inequality_logit)

males_raked_inequality_logit['mx raked'] = males_raked_inequality_logit['raked_value'] / \
    males_raked_inequality_logit['worldpop']
males_raked_inequality_logit['qx raked'] = 1.0 - np.exp(- males_raked_inequality_logit['t mean'] * \
    males_raked_inequality_logit['mx raked'])

# Save output
males_raked_inequality_logit.to_csv('/ihme/homes/ducela/stash/raking/scripts_dev/males_raked_inequality_logit.csv', index=False)
...
# Raking with inequality constraints with weights (logit distance)
females_raked_inequality_logit = []
for year in years:
    # Select values for year
    ...
    df_01y['raked_value'] = beta2
    df_raked = pd.concat([df_01m, df_01y])
    females_raked_inequality_logit.append(df_raked)
females_raked_inequality_logit = pd.concat(females_raked_inequality_logit)

females_raked_inequality_logit['mx raked'] = females_raked_inequality_logit['raked_value'] / \
    females_raked_inequality_logit['worldpop']
females_raked_inequality_logit['qx raked'] = 1.0 - np.exp(- females_raked_inequality_logit['t mean'] * \
    females_raked_inequality_logit['mx raked'])

# Save output
females_raked_inequality_logit.to_csv('/ihme/homes/ducela/stash/raking/scripts_dev/females_raked_inequality_logit.csv', index=False)
