...
# Raking with inequality constraints with weights (entropic distance)
males_raked_inequality_entropic = []
for year in years:
    ...
    res = raking_entropic_inequality(y, A, s, C, c, q)
    ...
    males_raked_inequality_entropic.append(df_raked)
males_raked_inequality_entropic = pd.concat(males_raked_inequality_entropic)

males_raked_inequality_entropic['mx raked'] = males_raked_inequality_entropic['raked_value'] / \
    males_raked_inequality_entropic['worldpop']
males_raked_inequality_entropic['qx raked'] = 1.0 - np.exp(- males_raked_inequality_entropic['t mean'] * \
    males_raked_inequality_entropic['mx raked'])

# Save output
males_raked_inequality_entropic.to_csv('/ihme/homes/ducela/stash/raking/scripts_dev/males_raked_inequality_entropic.csv', index=False)
...
# Raking with inequality constraints with weights (entropic distance)
females_raked_inequality_entropic = []
for year in years:
    # Select values for year
    ...
    df_01y['raked_value'] = beta2
    df_raked = pd.concat([df_01m, df_01y])
    females_raked_inequality_entropic.append(df_raked)
females_raked_inequality_entropic = pd.concat(females_raked_inequality_entropic)

females_raked_inequality_entropic['mx raked'] = females_raked_inequality_entropic['raked_value'] / \
    females_raked_inequality_entropic['worldpop']
females_raked_inequality_entropic['qx raked'] = 1.0 - np.exp(- males_raked_inequality_entropic['t mean'] * \
    females_raked_inequality_entropic['mx raked'])

# Save output
females_raked_inequality_entropic.to_csv('/ihme/homes/ducela/stash/raking/scripts_dev/females_raked_inequality_entropic.csv', index=False)
