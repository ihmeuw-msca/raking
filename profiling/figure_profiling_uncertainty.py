...
lu_time = [0.14339, 1.27817, 4.98063, 13.0978, 24.6151, 41.4776, 70.0496, 94.7001, 132.092, 178.872]
sp_time = [0.190271, 0.501126, 0.941338, 1.52781, 2.17216, 3.0226, 4.85216, 5.25561, 6.49375, 8.61088]
...
chart = alt.Chart(df).mark_line().encode(
    ...
    y = alt.Y('time:Q', axis=alt.Axis(title='Computation time')).scale(type='log'),
